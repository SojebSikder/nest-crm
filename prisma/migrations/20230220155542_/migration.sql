...
-- AddForeignKey
ALTER TABLE `templates` ADD CONSTRAINT `templates_workspace_channel_id_fkey` FOREIGN KEY (`workspace_channel_id`) REFERENCES `whatsapp_channels`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
